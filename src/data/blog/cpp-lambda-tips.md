...
pubDatetime: 2021-04-14T14:29:58.000Z
tags: ["cpp"]
description: "由于最近项目中用到了C++ Lambda表达式的相关内容，在这里记录一下。  什么是Lambda表达式 我自己理解的是Lambda表达式就是不需要复杂逻辑的匿名函数，在很多高级语言中都有。 比如Python中： 就可以在map中使用Lambda表达式使得程序更加简洁。  C++的Lambda表达式..."
---
