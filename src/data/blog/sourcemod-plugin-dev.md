...
pubDatetime: 2020-11-23T15:04:29.000Z
tags: ["game-dev", "tutorial"]
description: "概述 sourcemod是基于source引擎的插件系统，广泛用于l4d2，csgo等使用source引擎的游戏中，可以用来处理游戏事件和玩家的行为等。 sourcemod采用sourcepawn编写，sourcepawn是一种轻量级编译语言，编译器由sourcemod官方下载页面给出，包含linu..."
---
