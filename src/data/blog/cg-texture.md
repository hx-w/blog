---
title: "计算机图形学-纹理"
pubDatetime: 2020-12-16T06:21:54.000Z
tags: ["graphics", "note"]
description: "概述 纹理映射是着色部分的内容，包括了抗混叠等技术。  重心坐标 Barycentric Coordinates 重心坐标是定义在三角形上的，表示为，满足： 当点在三角形内时，满足： 重心坐标可以通过面积比求出，如图 除了用面积算，还可以直接通过笛卡尔坐标系下的坐标进行计算  使用重心坐标进行插值..."
---
...
![](/images/cg-texture/CG-5-1.png)

除了用面积算，还可以直接通过笛卡尔坐标系下的坐标进行计算

![](/images/cg-texture/CG-5-2.png)
