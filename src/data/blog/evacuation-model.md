---
title: "简单疏散模型(2019美赛)"
pubDatetime: 2019-02-01T16:00:00.000Z
tags: ["algorithm", "python"]
description: "概述 这一切要从2019MCM/ICM(题目下载地址)开始说起，我们小组拿到题目之后经过讨论选择了D题。这其实也是我个人的意向，因为今年的题目普遍需要生物和金融方面的知识，而我们组除了我是计科专业的，其他两位都是做理论物理方向，而今年的题目普遍没有物理发挥的余地，所以我尽量去找一些适合计科的题目。但..."
---
## 概述

这一切要从**2019MCM/ICM**（[题目下载地址](https://www.comap.com/undergraduate/contests/mcm/contests/2019/problems/)）开始说起，我们小组拿到题目之后经过讨论选择了D题。这其实也是我个人的意向，因为今年的题目普遍需要生物和金融方面的知识，而我们组除了我是计科专业的，其他两位都是做理论物理方向，而今年的题目普遍没有物理发挥的余地，所以我尽量去找一些适合计科的题目。但B题C题给我的第一感觉就是只有我一个人写程序做数据处理肯定搞不定，所以我和小组都将目标放在了我有点思路的D题上。
...
![示例](/images/evacuation-model/simple_model-post-inf-struct.jpg)
...
$$
\begin{aligned}
\forall v_k \in N^-(v_i), \quad e(v_i, v_k) \rightarrow \epsilon
&= \frac{\min(v_k\rightarrow N, e(v_i, v_k) \rightarrow F_l \times U_t)}{\sum_{v\in N^-(v_i)} \min(v\rightarrow N, e(v_i, v) \rightarrow F_l \times U_t)}
\end{aligned}
$$
...
![结果](/images/evacuation-model/simple_model-result.png)
