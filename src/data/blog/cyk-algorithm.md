---
title: "CYK算法实现"
pubDatetime: 2019-04-28T11:26:15.000Z
tags: ["algorithm", "python"]
description: "概述 在计算机科学领域，CYK算法（也称为Cocke–Younger–Kasami算法）是一种用来对上下文无关文法（CFG，Context Free Grammar）进行语法分析（parsing）的算法。该算法最早由John Cocke, Daniel Younger and Tadao Kasam..."
---
...
![commandline](/images/cyk-algorithm/CYK-CYK_1.png)

![GUI](/images/cyk-algorithm/CYK-CYK_2.png)
