...
pubDatetime: 2023-06-19T15:04:39.000Z
tags: ["python", "tools"]
description: "- manim 是社区维护版 - manimgl 是3Blue1Brown使用的版本 一般可以使用manim社区维护版。 在MacOS上安装manim时，除了按照官网上的描述操作外，也容易出现一些其他问题。 我遇到的： 会报错找不到这个库。 解决方法： 1. 去 x.org/archive/indi..."
---
